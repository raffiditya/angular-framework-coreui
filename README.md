# CoreUI Angular 2+ Admin Template 

CoreUI is based on: [Github](https://github.com/coreui/coreui-angular).
...
The documentation for the CoreUI Free Angularp Admin Template is hosted at website [CoreUI](https://coreui.io/angular/)
...
For transparency into Core UI's release cycle and in striving to maintain backward compatibility,CoreUI Free Admin Template is maintained under [the Semantic Versioning guidelines](http://semver.org/).
